  ...
  return (
    ...
    <div className="m-auto mt-10"> 
      ...
      <div className='mt-50 w-80 m-auto'>
        ...
        <p className='mt-10 text-info'>Dans la méthode Merise, le modèle physique des données (MPD) consiste à implanter une base de données dans un SGBDR. Le langage utilisé pour ce type d'opération est le SQL.</p>
      </div>
